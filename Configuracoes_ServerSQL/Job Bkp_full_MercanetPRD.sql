...
/****** Object:  Job [Bkp_full_MercanetPRD]    Script Date: 17/03/2022 11:39:27 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 17/03/2022 11:39:27 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'Bkp_full_MercanetPRD', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Bkp_full_MercanetPRD]    Script Date: 17/03/2022 11:39:27 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Bkp_full_MercanetPRD', 
		@step_id=1, 
...
declare @nome_banco varchar (max) set @nome_banco = ''MercanetPRD'';
