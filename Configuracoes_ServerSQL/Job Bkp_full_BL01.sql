...
/****** Object:  Job [Bkp_full_BL01]    Script Date: 17/03/2022 11:39:32 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 17/03/2022 11:39:32 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'Bkp_full_BL01', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Bkp_full_BL01]    Script Date: 17/03/2022 11:39:32 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Bkp_full_BL01', 
		@step_id=1, 
...
declare @nome_banco varchar (max) set @nome_banco = ''BL01'';
...
declare @destino varchar (max) set @destino = ''\\192.168.1.104\bkp-SQL\BL01\''; 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Diario as 01 Hrs', 
		@enabled=1, 
		@freq_type=4, 
		@freq_interval=1, 
		@freq_subday_type=1, 
		...
		@active_start_time=34100, 
		@active_end_time=235959, 
		@schedule_uid=N'5179a249-7224-4a5d-bbc8-331f126301d0'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
