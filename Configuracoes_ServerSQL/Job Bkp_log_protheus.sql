...
/****** Object:  Job [Bkp_log_protheus]    Script Date: 17/03/2022 11:38:58 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 17/03/2022 11:38:58 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'Bkp_log_protheus', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Bkp_log_protheus]    Script Date: 17/03/2022 11:38:58 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Bkp_log_protheus', 
		@step_id=1, 
...
declare @nome_banco varchar (50) set @nome_banco = ''Protheus'';
