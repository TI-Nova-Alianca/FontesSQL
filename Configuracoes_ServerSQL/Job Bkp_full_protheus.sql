...
/****** Object:  Job [Bkp_full_protheus]    Script Date: 17/03/2022 11:39:13 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 17/03/2022 11:39:13 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'Bkp_full_protheus', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Bkp_full_protheus]    Script Date: 17/03/2022 11:39:13 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Bkp_full_protheus', 
		@step_id=1, 
...
declare @nome_banco varchar (max) set @nome_banco = ''Protheus'';
...
declare @destino varchar (max) set @destino = ''\\192.168.1.104\bkp-SQL\Protheus\''; 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Diario 6 em 6 Hrs as 00:30', 
		@enabled=1, 
		@freq_type=4, 
		@freq_interval=1, 
		@freq_subday_type=8, 
		...
		@schedule_uid=N'ad7236bd-6fa2-42eb-b5da-a7282ccd1f0f'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
