...
--DELETE VA_SIMUL_LCTOS WHERE TABELA = 'SD2'
...
SELECT ROUND (CASE CTADEB WHEN '' THEN 0 ELSE VALOR END, 2) AS VLR_DEB
	...
	--, V.*
	, SD3.* -- SD3.D3_EMISSAO, SD3.D3_DOC, SD3.D3_COD, D3_OP, B1_TIPO as TIPO_PROD_FINAL
...
SELECT * FROM C
WHERE VLR_DEB = 0 AND VLR_CRED = 0
AND D3_COD NOT LIKE 'MMM%'
AND D3_COD NOT LIKE 'AO-%'
AND D3_COD NOT LIKE 'AP-%'
AND D3_COD NOT LIKE 'MAN%'
AND D3_COD NOT LIKE 'MOD%'
AND D3_CF != 'RE9'
AND D3_CF != 'RE4'
AND D3_CF != 'DE4'
AND D3_TIPO != 'MC'  -- ITENS DE CONTRATO NAO DEVE CONTABILIZAR
--and D3_COD = '0345'
--and LPAD = '610'
...
AND SD3.D3_EMISSAO BETWEEN '20220501' AND '20220531'
AND NOT EXISTS (SELECT *
				FROM VA_SIMUL_LCTOS V
				WHERE TABELA = 'SD3'
...
*/
--SELECT C2_VAOPESP, * FROM SC2010 WHERE C2_FILIAL = '01' AND C2_NUM = '124483'