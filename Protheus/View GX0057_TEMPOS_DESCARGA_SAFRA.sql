...
SELECT --SUBSTRING (DATA, 7, 2) AS DIA
	...
	, V.DATA + ' ' + V.HORA AS GERACAO_CARGA
	, ZZA.ZZA_INIST1 AS PESAGEM1
	, ZZA.ZZA_INIST2 AS INI_MED_GRAU
	, ZZA.ZZA_INIST3 AS FIM_MED_GRAU
	, SPED.DT_HR_AUTORIZ AS CONTRANOTA
...
SELECT SAFRA AS GX0057_SAFRA
	...
	, DATEDIFF (MINUTE, AGENDAMENTO, GERACAO_CARGA) AS GX0057_MINUTOS_CHEGADA
	, GERACAO_CARGA AS GX0057_GERACAO_CARGA
	, DATEDIFF (MINUTE, GERACAO_CARGA, PESAGEM1) AS GX0057_MINUTOS_FILA_RUA
	, PESAGEM1 AS GX0057_PESAGEM1
	, DATEDIFF (MINUTE, PESAGEM1, INI_MED_GRAU) AS GX0057_MINUTOS_FILA_TOMBADOR
	, INI_MED_GRAU AS GX0057_INI_MED_GRAU
	, DATEDIFF (MINUTE, INI_MED_GRAU, FIM_MED_GRAU) AS GX0057_MINUTOS_MEDINDO_GRAU
	, FIM_MED_GRAU AS GX0057_FIM_MED_GRAU
	, DATEDIFF (MINUTE, INI_MED_GRAU, FIM_MED_GRAU) AS GX0057_MINUTOS_FILA_CONTRANOTA
	, CONTRANOTA AS GX0057_CONTRANOTA
	, DATEDIFF (MINUTE, GERACAO_CARGA, CONTRANOTA) AS GX0057_MINUTOS_TOTAL
	, NOME_ASSOC AS GX0057_NOME_ASSOC
	, DESCRICAO AS GX0057_DESCRICAO
