...
BEGIN
	...
	, SUB_NIVEIS AS (
		...
		FROM ESTRUTURA
			, SUB_CTS
		WHERE SUB_CTS.CTS_VAGDRE = ESTRUTURA.CODGRUPO
	)
	...
	SELECT
		...
		'F' AS ORC_PER_FP,
		0 AS ORC_PER_AV,
		SUM (REA_MES          * CASE SUB_NIVEIS.CTS_NORMAL WHEN '1' THEN 1 ELSE -1 END * CASE WHEN SUBSTRING (SUB_NIVEIS.CODGRUPO, 1, 1) IN ('2', '4', '6') THEN -1 ELSE 1 END) AS REA_MES,
		'F' AS REA_MES_FP,
		0 AS REA_MES_AV,
		SUM (REALIZADO        * CASE SUB_NIVEIS.CTS_NORMAL WHEN '1' THEN 1 ELSE -1 END * CASE WHEN SUBSTRING (SUB_NIVEIS.CODGRUPO, 1, 1) IN ('2', '4', '6') THEN -1 ELSE 1 END) AS REA_PER,
		'F' AS REA_PER_FP,
		0 AS REA_PER_AV,
		SUM (REALIZADO_ANOANT * CASE SUB_NIVEIS.CTS_NORMAL WHEN '1' THEN 1 ELSE -1 END * CASE WHEN SUBSTRING (SUB_NIVEIS.CODGRUPO, 1, 1) IN ('2', '4', '6') THEN -1 ELSE 1 END) AS REA_ANT,
		'F' AS REA_ANT_FP,
		0 AS REA_ANT_AV,
...
--	WHERE EXISTS (SELECT * FROM @LIBERACOES L WHERE CC LIKE L.LIB_CC AND 'GRUPO' + CAST (CODGRUPO AS VARCHAR (4)) = L.LIB_CONTA)
	...
	UPDATE @RET SET ORC_ANO    = ISNULL ((SELECT SUM (ORC_ANO)    FROM @RET WHERE CODGRUPO IN ('03', '04') AND INFORMATIVO != 'S'), 0)
				   ,ORC_ANO_FP = ISNULL ((SELECT MAX (ORC_ANO_FP) FROM @RET WHERE CODGRUPO IN ('03', '04') AND INFORMATIVO != 'S'), 0)  -- CONSEGUI USAR 'MAX' AQUI POR QUE SEMPRE TEM [FP], E P EH MAIOR QUE F, E BASTA TEM UM P EM QQUER LINHA PARA QUE ASSUMA P NO NIVEL ACIMA.
	               ,ORC_PER    = ISNULL ((SELECT SUM (ORC_PER)    FROM @RET WHERE CODGRUPO IN ('03', '04') AND INFORMATIVO != 'S'), 0)
				   ,ORC_PER_FP = ISNULL ((SELECT MAX (ORC_PER_FP) FROM @RET WHERE CODGRUPO IN ('03', '04') AND INFORMATIVO != 'S'), 0)  -- CONSEGUI USAR 'MAX' AQUI POR QUE SEMPRE TEM [FP], E P EH MAIOR QUE F, E BASTA TEM UM P EM QQUER LINHA PARA QUE ASSUMA P NO NIVEL ACIMA.
	               ,REA_MES    = ISNULL ((SELECT SUM (REA_MES)    FROM @RET WHERE CODGRUPO IN ('03', '04') AND INFORMATIVO != 'S'), 0)
				   ,REA_MES_FP = ISNULL ((SELECT MAX (REA_MES_FP) FROM @RET WHERE CODGRUPO IN ('03', '04') AND INFORMATIVO != 'S'), 0)  -- CONSEGUI USAR 'MAX' AQUI POR QUE SEMPRE TEM [FP], E P EH MAIOR QUE F, E BASTA TEM UM P EM QQUER LINHA PARA QUE ASSUMA P NO NIVEL ACIMA.
	               ,REA_PER    = ISNULL ((SELECT SUM (REA_PER)    FROM @RET WHERE CODGRUPO IN ('03', '04') AND INFORMATIVO != 'S'), 0)
				   ,REA_PER_FP = ISNULL ((SELECT MAX (REA_PER_FP) FROM @RET WHERE CODGRUPO IN ('03', '04') AND INFORMATIVO != 'S'), 0)  -- CONSEGUI USAR 'MAX' AQUI POR QUE SEMPRE TEM [FP], E P EH MAIOR QUE F, E BASTA TEM UM P EM QQUER LINHA PARA QUE ASSUMA P NO NIVEL ACIMA.
	               ,REA_ANT    = ISNULL ((SELECT SUM (REA_ANT)    FROM @RET WHERE CODGRUPO IN ('03', '04') AND INFORMATIVO != 'S'), 0)
				   ,REA_ANT_FP = ISNULL ((SELECT MAX (REA_ANT_FP) FROM @RET WHERE CODGRUPO IN ('03', '04') AND INFORMATIVO != 'S'), 0)  -- CONSEGUI USAR 'MAX' AQUI POR QUE SEMPRE TEM [FP], E P EH MAIOR QUE F, E BASTA TEM UM P EM QQUER LINHA PARA QUE ASSUMA P NO NIVEL ACIMA.
			WHERE CODPLA = @VISAO_PRINCIPAL AND CODGRUPO = '5'
...
/*
	...
	SET @CEMPORCENTO = (SELECT SUM (ORC_ANO) FROM @RET WHERE CODPLA = @VISAO_PRINCIPAL AND CODGRUPO = 1)
	IF (@CEMPORCENTO != 0)
		UPDATE @RET SET ORC_ANO_AV = round (ORC_ANO * 100 / @CEMPORCENTO, 2)
		WHERE CODPLA = @VISAO_PRINCIPAL AND CODGRUPO < 5

	SET @CEMPORCENTO = (SELECT SUM (ORC_PER) FROM @RET WHERE CODPLA = @VISAO_PRINCIPAL AND CODGRUPO = 1)
	IF (@CEMPORCENTO > 0)
		UPDATE @RET SET ORC_PER_AV = round (ORC_PER * 100 / @CEMPORCENTO, 2)
		WHERE CODPLA = @VISAO_PRINCIPAL AND CODGRUPO < 5

	SET @CEMPORCENTO = (SELECT SUM (REA_MES) FROM @RET WHERE CODPLA = @VISAO_PRINCIPAL AND CODGRUPO = 1)
	IF (@CEMPORCENTO > 0)
		UPDATE @RET SET REA_MES_AV = round (REA_MES * 100 / @CEMPORCENTO, 2)
		WHERE CODPLA = @VISAO_PRINCIPAL AND CODGRUPO < 5

	SET @CEMPORCENTO = (SELECT SUM (REA_PER) FROM @RET WHERE CODPLA = @VISAO_PRINCIPAL AND CODGRUPO = 1)
	IF (@CEMPORCENTO > 0)
		UPDATE @RET SET REA_PER_AV = round (REA_PER * 100 / @CEMPORCENTO, 2)
		WHERE CODPLA = @VISAO_PRINCIPAL AND CODGRUPO < 5

	SET @CEMPORCENTO = (SELECT SUM (REA_ANT) FROM @RET WHERE CODPLA = @VISAO_PRINCIPAL AND CODGRUPO = 1)
	IF (@CEMPORCENTO > 0)
	...
	SET @CEMPORCENTO = (SELECT SUM (ORC_ANO) FROM @RET WHERE CODPLA = @VISAO_PRINCIPAL AND CODGRUPO = 5)
	IF (@CEMPORCENTO > 0)
		UPDATE @RET SET ORC_ANO_AV = round (ORC_ANO * 100 / @CEMPORCENTO, 2)
		WHERE CODPLA = @VISAO_PRINCIPAL AND CODGRUPO >= 5

	SET @CEMPORCENTO = (SELECT SUM (ORC_PER) FROM @RET WHERE CODPLA = @VISAO_PRINCIPAL AND CODGRUPO = 5)
	IF (@CEMPORCENTO > 0)
		UPDATE @RET SET ORC_PER_AV = round (ORC_PER * 100 / @CEMPORCENTO, 2)
		WHERE CODPLA = @VISAO_PRINCIPAL AND CODGRUPO >= 5

	SET @CEMPORCENTO = (SELECT SUM (REA_MES) FROM @RET WHERE CODPLA = @VISAO_PRINCIPAL AND CODGRUPO = 5)
	IF (@CEMPORCENTO > 0)
		UPDATE @RET SET REA_MES_AV = round (REA_MES * 100 / @CEMPORCENTO, 2)
		WHERE CODPLA = @VISAO_PRINCIPAL AND CODGRUPO >= 5

	SET @CEMPORCENTO = (SELECT SUM (REA_PER) FROM @RET WHERE CODPLA = @VISAO_PRINCIPAL AND CODGRUPO = 5)
	IF (@CEMPORCENTO > 0)
		UPDATE @RET SET REA_PER_AV = round (REA_PER * 100 / @CEMPORCENTO, 2)
		WHERE CODPLA = @VISAO_PRINCIPAL AND CODGRUPO >= 5

	SET @CEMPORCENTO = (SELECT SUM (REA_ANT) FROM @RET WHERE CODPLA = @VISAO_PRINCIPAL AND CODGRUPO = 5)
	IF (@CEMPORCENTO > 0)
		UPDATE @RET SET REA_ANT_AV = round (REA_ANT * 100 / @CEMPORCENTO, 2)
		WHERE CODPLA = @VISAO_PRINCIPAL AND CODGRUPO >= 5
*/
