...
-- 02/05/2022 - Robert - Incluidas diversas colunas para poder usar esta funcao na montagem da arvore de rastreabilidade no Protheus (GLPI 11980)
--                     - Reformatacao e reindentacao do programa
--
	...
	(
		...
		SELECT '2' AS TIPO_REG
			...
			, CASE 
				...
				WHEN SUBSTRING(SD3.D3_CF, 3, 1) = '4'
					AND CONTRAPARTIDA.D3_COD = SD3.D3_COD
					THEN CASE WHEN CONTRAPARTIDA.D3_LOTECTL = SD3.D3_LOTECTL
						THEN 'TR.ENDER. '
							+ CASE SUBSTRING(SD3.D3_CF, 1, 2)
								WHEN 'DE'
								THEN CONTRAPARTIDA.D3_LOCAL + '/' + RTRIM (CONTRAPARTIDA.D3_LOCALIZ) + ' -> ' + SD3.D3_LOCAL + '/' + RTRIM (SD3.D3_LOCALIZ)
