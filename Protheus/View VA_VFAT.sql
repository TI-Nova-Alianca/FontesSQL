...
/****** Object:  View [dbo].[VA_VFAT]    Script Date: 10/05/2022 13:44:50 ******/
SET ANSI_NULLS ON
GO
...
-- 05/11/2019 - Claudia - Realizada a troca da multiplica̤̣o de qnt*vlr unitario para valor total para notas de entrada, devido a problemas nas devolṳ̵es.
-- 24/02/2020 - Claudia - Incluido case na verifica̤̣o do campo RAPELPREV, para ṇo dar erro de diviṣo por zero
-- 30/03/2020 - Robert  - Aumentado tamanho dos campos D2_ITEM e D1_ITEMORI, D2_ITEMPV, C6_ITEM (GLPI 7740)
-- 02/04/2020 - Claudia - Voltada as altera̵̤es D2_ITEM e D1_ITEMORI, D2_ITEMPV, C6_ITEM (GLPI 7741)
...
SELECT
 ...
 --  ,SD2.D2_ITEM AS ITEMNOTA
   ,SB1.B1_PESBRU * SD2.D2_QUANT AS PESOBRUTO
   ,SD2.D2_UM AS UMPROD
   ,'' AS UMPRODPAI
...
SELECT
   ...
   ,SB1.B1_PESBRU * SD1.D1_QUANT AS PESOBRUTO
   ,SD1.D1_UM AS UMPROD
   ,'' AS UMPRODPAI
