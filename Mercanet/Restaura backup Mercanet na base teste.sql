...
declare @nome_arq_bkp varchar (60) = N'n:\MercanetPRD\MercanetPRD_Full 01-00 30-09-2021.bak'
...
NORECOVERY  -- isso por que quero restaurar algum arquivo de log em seguida
GO

-- Restaura alguns arquivos de backup log
use master;
RESTORE LOG [MercanetHML] FROM DISK = N'n:\MercanetPRD\MercanetPRD_Log 30-09-2021 02-00.trn' WITH FILE = 1, NORECOVERY
RESTORE LOG [MercanetHML] FROM DISK = N'n:\MercanetPRD\MercanetPRD_Log 30-09-2021 03-00.trn' WITH FILE = 1, NORECOVERY
RESTORE LOG [MercanetHML] FROM DISK = N'n:\MercanetPRD\MercanetPRD_Log 30-09-2021 04-00.trn' WITH FILE = 1, NORECOVERY
RESTORE LOG [MercanetHML] FROM DISK = N'n:\MercanetPRD\MercanetPRD_Log 30-09-2021 05-00.trn' WITH FILE = 1, NORECOVERY
RESTORE LOG [MercanetHML] FROM DISK = N'n:\MercanetPRD\MercanetPRD_Log 30-09-2021 06-00.trn' WITH FILE = 1, NORECOVERY
RESTORE LOG [MercanetHML] FROM DISK = N'n:\MercanetPRD\MercanetPRD_Log 30-09-2021 07-00.trn' WITH FILE = 1, NORECOVERY
RESTORE LOG [MercanetHML] FROM DISK = N'n:\MercanetPRD\MercanetPRD_Log 30-09-2021 08-00.trn' WITH FILE = 1, NORECOVERY
RESTORE LOG [MercanetHML] FROM DISK = N'n:\MercanetPRD\MercanetPRD_Log 30-09-2021 09-00.trn' WITH FILE = 1, NORECOVERY
RESTORE LOG [MercanetHML] FROM DISK = N'n:\MercanetPRD\MercanetPRD_Log 30-09-2021 10-00.trn' WITH FILE = 1
...
ALTER DATABASE [MercanetHML] MODIFY FILE (NAME=N'MercanePRD', NEWNAME=N'MercanetHML')
