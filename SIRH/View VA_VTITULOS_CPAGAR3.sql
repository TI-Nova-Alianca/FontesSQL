...
WITH CTE AS (
	...
	-- Pagamentos de IRF (mes atual)
	SELECT 'IRF_MES_ATUAL' AS ORIGEM
		, C.EMPRESA
		, C.DATAINCLUSAO
	...
	FROM RHCONTASPAGARHIST C
		...
		JOIN (SELECT D.EMPRESA
					...
					AND D.ANOMESBASE = (SELECT	MAX(D2.ANOMESBASE)
					 ...
					 AND DATAEMISSAO < '2023-05-05 00:00'  -- TESTE
					GROUP BY D.EMPRESA
							,D.UNIDADE
							,D.DATAEMISSAO
	...
	-- Pagamentos de IRF (mes seguinte)
	SELECT 'IRF_MES_FUTURO' AS ORIGEM
		, C.EMPRESA
		, C.DATAINCLUSAO
